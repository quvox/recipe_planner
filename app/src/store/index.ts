...
function generatePrompt(formData: MenuFormData): string {
  ...
  return `以下の条件で、30分以内で作れる時短料理の献立を5つ提案してください。

【条件】
- 使用食材: ${ingredientsList}
- テーマ: ${theme}
- 人数構成: ${peoplePattern}
- 調理時間: 30分以内
- 家庭で作りやすい料理
...
[
  {
    "title": "献立名（100文字程度の詳細な説明を含む）",
    "description": "料理の概要説明（2-3行程度）",
    "ingredients": ["食材A（分量）", "食材B（分量）", "食材C（分量）"],
    "steps": ["手順1（50文字前後で詳しく説明）", "手順2（50文字前後で詳しく説明）", "手順3（50文字前後で詳しく説明）"],
    "time": 25
  },
  {
    "title": "献立名2（100文字程度の詳細な説明を含む）",
    "description": "料理の概要説明（2-3行程度）",
    "ingredients": ["食材D（分量）", "食材E（分量）", "食材F（分量）"],
    "steps": ["手順1（50文字前後で詳しく説明）", "手順2（50文字前後で詳しく説明）", "手順3（50文字前後で詳しく説明）"],
    "time": 20
  },
  {
    "title": "献立名3（100文字程度の詳細な説明を含む）",
    "description": "料理の概要説明（2-3行程度）",
    "ingredients": ["食材G（分量）", "食材H（分量）", "食材I（分量）"],
    "steps": ["手順1（50文字前後で詳しく説明）", "手順2（50文字前後で詳しく説明）", "手順3（50文字前後で詳しく説明）"],
    "time": 30
  },
  {
    "title": "献立名4（100文字程度の詳細な説明を含む）",
    "description": "料理の概要説明（2-3行程度）",
    "ingredients": ["食材J（分量）", "食材K（分量）", "食材L（分量）"],
    "steps": ["手順1（50文字前後で詳しく説明）", "手順2（50文字前後で詳しく説明）", "手順3（50文字前後で詳しく説明）"],
    "time": 25
  },
  {
    "title": "献立名5（100文字程度の詳細な説明を含む）",
    "description": "料理の概要説明（2-3行程度）",
    "ingredients": ["食材M（分量）", "食材N（分量）", "食材O（分量）"],
    "steps": ["手順1（50文字前後で詳しく説明）", "手順2（50文字前後で詳しく説明）", "手順3（50文字前後で詳しく説明）"],
    "time": 20
  }
]

注意: timeフィールドは調理時間を分単位の数値で指定してください。

※JSONの配列形式以外は含めないでください。`;
}